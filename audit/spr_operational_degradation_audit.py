...
Related modules:
  - eroi_real_time_audit -- current-period fuel price inputs
  - energy_cascade_audit -- broader oil-cascade context (cites SPR)
  - shale_well_thermodynamic_reality_module -- domestic production reality
  - failure_geometry_analysis -- design-vs-actual mismatch as a comfort-design failure
  - timing_as_constraint -- design envelope as scope constraint
"""
