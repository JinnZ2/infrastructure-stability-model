...
def lifecycle_energy_cost(
    ...
    return {
        ...
        "ratio_counteract_to_adaptation": counteract_total / adaptation_total
...
if __name__ == "__main__":
    ...
    cycles = [
        Cycle("foundation_settlement_check", 2.0, "differential_settlement", 10.0, "mm"),
        Cycle("material_density_check", 5.0, "wood_density_loss", 8.0, "%"),
        Cycle("substrate_motion_resurvey", 1.0, "vertical_land_motion", 25.0, "mm/yr"),
    ]
